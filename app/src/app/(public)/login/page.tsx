...
function LoginForm() {
  ...
  const errorMessages: Record<string, string> = {
    access_denied: 'Il tuo account non è autorizzato ad accedere a ContentFlix. Contatta l\'amministratore.',
    exchange_failed: 'Accesso fallito. Riprova tra qualche momento.',
    no_user: 'Impossibile recuperare le informazioni utente. Riprova.',
    no_code: 'Richiesta non valida. Riprova.',
  }
        ...
        <div className="bg-surface-container-lowest rounded-3xl shadow-ambient p-10">
          ...
          <div className="mt-6 p-4 bg-surface-container-low rounded-xl">
            <p className="text-xs text-on-surface-variant text-center leading-relaxed">
              <strong className="text-on-surface">Accesso su invito.</strong>
              {' '}Solo gli utenti autorizzati dall&apos;amministratore possono accedere a ContentFlix.
            </p>
          </div>
